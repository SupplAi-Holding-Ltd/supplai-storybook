...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    Welcome to the Supplai Design System. This Storybook documents the foundational design decisions and reusable UI components that power our product. Use the sidebar to explore Foundation guidelines and Components.
  </div>
